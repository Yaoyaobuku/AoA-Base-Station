        ...
        for i in range(0,8):
            if i in data:
                ...
                if data[i]['samples'].any() != None:
                    ...
                    plt.plot(range(0,len(data[i]['samples'])),data[i]['samples'], alpha=0.5)
                    ...
                    if i >= 0:
                        if 0 in data:
                            ...
                            fft_0 = np.fft.fft(data[0]['samples'])
                            fft_i = np.fft.fft(data[i]['samples'])
                    ...
                    if 'shift' in data[i]:
                        # if i > 0:
                        shifted_data = np.roll(data[i]['samples'], data[i]['shift'])
                        # else:
...
# tasks.append(plotloop(sdr.sample_rate,sdr.center_freq,i))
